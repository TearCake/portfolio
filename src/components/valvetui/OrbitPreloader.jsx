...
const DEFAULT_ORBIT_TEXTS = [
  { href: "#loader-orbit-1", startOffset: "30%", textLength: 300, label: "TearCake" },
  { href: "#loader-orbit-2", startOffset: "31%", textLength: 280, label: "AI / ML Engineer" },
  { href: "#loader-orbit-3", startOffset: "33%", textLength: 240, label: "Next-Gen AI" },
  { href: "#loader-orbit-4", startOffset: "32%", textLength: 260, label: "PyTorch" },
  { href: "#loader-orbit-5", startOffset: "30%", textLength: 290, label: "Portfolio" },
  { href: "#loader-orbit-6", startOffset: "31%", textLength: 200, label: "Full Stack" },
  { href: "#loader-orbit-7", startOffset: "33%", textLength: 210, label: "React" },
  { href: "#loader-orbit-8", startOffset: "32%", textLength: 190, label: "Aditya" },
];
...
export default function OrbitPreloader({
  ...
  useEffect(() => {
    ...
    textPaths.forEach((textPath, index) => {
      const startTextLength = orbitTexts[index]?.textLength || 250;
      const startOffset = parseFloat(orbitTexts[index]?.startOffset || "30%");
    ...
    // ── 2. Random SVG rotation (Original Valvet UI) ──────────────────────────
    ...
    // ── 5. Orbit-text fade out → loader exit ────────────────────────────────
    gsap.to(orbitTextsReversed, {
      opacity: 0,
      duration: 0.75,
      stagger: 0.1,
  ...
  return (
    ...
    >
      ...
      >
        {/* Orbit paths (invisible circular guides) */}
        {ORBIT_PATHS.map((p) => (
